...
final class HistoryStore: ObservableObject {
    ...
    private let log = Logger(subsystem: "com.naktor.barktor", category: "history")
    ...
    nonisolated static var defaultDirectory: URL {
        FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask)[0]
            .appendingPathComponent("Barktor/History", isDirectory: true)
    }
    ...
    private static func load(from directory: URL) -> [DictationEntry] {
        ...
        Logger(subsystem: "com.naktor.barktor", category: "history")

...
final class ParakeetEngine: TranscriptionEngine {
    ...
    private let log = Logger(subsystem: "com.naktor.barktor", category: "parakeet")
    ...
    // Where the batch Parakeet TDT v2 weights live. Routed under Barktor's own
...
final class StreamingEouAsrSession: StreamingSession {
    ...
    private let log = Logger(subsystem: "com.naktor.barktor", category: "parakeet.eou")
